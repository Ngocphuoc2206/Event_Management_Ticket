    ...
    if (router.isReady && id) {
      ...
      if (!savedUsers) {
        ...
        localStorage.setItem(
          USERS_STORAGE_KEY,
          JSON.stringify(MOCK_USERS_DETAIL),
        );
      } else {
              ...
              <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm relative overflow-hidden">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="text-xs font-black text-emerald-500">
                    {currentUser.stats.eventsGrowth} this year
                  </span>
                </div>
                <h3 className="text-4xl font-black text-slate-900 mb-2">
                  {currentUser.stats.eventsHosted}
                </h3>
              ...
              <div className="bg-white p-8 rounded-[40px] border border-slate-100 shadow-sm">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <span className="text-xs font-black text-slate-500">
                    {currentUser.stats.sellThrough} sell-through
                  </span>
                </div>
                <h3 className="text-4xl font-black text-slate-900 mb-2">
                  {currentUser.stats.ticketsSold}
                </h3>
                <p className="text-[11px] font-black text-slate-400 uppercase tracking-widest">
                  Total Tickets Sold
                </p>
            ...
            <div className="bg-white rounded-[40px] p-8 border border-slate-100 shadow-sm">
              <div className="flex justify-between items-center mb-8">
                <h3 className="text-[12px] font-black uppercase tracking-[0.2em] text-slate-900 flex items-center gap-2">
                  <Activity size={16} className="text-indigo-600" /> Recent
                  Activity
                </h3>
              ...
              <div className="space-y-6">
                  ...
                  <div className="flex-1 pb-6 border-b border-slate-50">
                    <div className="flex justify-between items-start">
                      <h4 className="text-sm font-black text-slate-900">
                        Published &ldquo;Summer Jazz Festival 2024&ldquo;
                      </h4>
                    ...
                    <p className="text-xs text-slate-500 font-medium mt-1">
                      New event created with 500 ticket capacity.
                    </p>
                  </div>
                </div>
                {/* Activity 2 */}
                <div className="flex gap-4 items-start group">
                  ...
                  <div className="flex-1 pb-6 border-b border-slate-50">
                    ...
                    <p className="text-xs text-slate-500 font-medium mt-1">
                      Automatic monthly settlement for May ticket sales.
                    </p>
                  </div>
                </div>
                {/* Activity 3 */}
                <div className="flex gap-4 items-start group">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-slate-500 font-medium mt-1">
                      Changed business address and bank details.
                    </p>
                  </div>
                </div>
              </div>
                ...
                {[
                  {
                    ...
                    img: "https://images.unsplash.com/photo-1511192336575-5a79af67a629?q=80&w=400&auto=format&fit=crop",
                    rev: "$15,400",
                  },
                  {
                  ...
                  },
                  {
                    ...
                    img: "https://images.unsplash.com/photo-1561214115-f2f134cc4912?q=80&w=400&auto=format&fit=crop",
                    rev: "$8,900",
                  },
                ].map((ev, i) => (
                  <div
                    key={i}
                    className="bg-white rounded-[24px] p-3 border border-slate-100 shadow-sm group cursor-pointer hover:shadow-md transition-all"
                  >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-[40px] p-8 border border-slate-100 shadow-sm">
              ...
              <div className="bg-slate-50 rounded-3xl p-5 mb-8 flex justify-between items-center border border-slate-100">
                ...
                >
                  <span
                    className={`w-1.5 h-1.5 rounded-full ${currentUser.status === "ACTIVE" ? "bg-indigo-600" : "bg-rose-600"} animate-pulse`}
                  ></span>
                  {currentUser.status}
                </span>
              </div>

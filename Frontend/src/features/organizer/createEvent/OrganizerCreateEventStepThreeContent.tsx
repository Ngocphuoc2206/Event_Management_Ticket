        ...
        <div className="w-full space-y-12">
          <section className="space-y-4">
            ...
            <div className="h-2 overflow-hidden rounded-full bg-gray-200">
              <div className="h-full w-3/5 bg-indigo-600" />
            </div>
          </section>
          ...
          <section className="grid gap-8 xl:grid-cols-[1.55fr_1fr]">
            <div className="space-y-8">
              <section className="space-y-6">
                ...
                <div className="rounded-[32px] bg-white px-8 py-20 outline outline-2 outline-slate-300">
            ...
            <aside className="space-y-6">
              <article className="rounded-[32px] bg-gradient-to-br from-gray-100 to-slate-100 p-6 outline outline-1 outline-slate-300/10">
              ...
              <article className="rounded-[32px] bg-white p-6 outline outline-1 outline-slate-300/20 shadow-[0px_0px_32px_0px_rgba(25,28,30,0.05)]">
          ...
          <footer className="flex items-center justify-between border-t border-gray-100 pt-10">
            ...
            <div className="flex items-center gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-2xl bg-indigo-600 px-10 py-3 text-base font-bold text-white shadow-[0px_4px_6px_-4px_rgba(0,88,190,0.20),0px_10px_15px_-3px_rgba(0,88,190,0.20)]"
              >
                Next Step: Tickets
                <ChevronDown className="h-4 w-4 -rotate-90" />
              </Link>

              ...
              <div className="bg-white rounded-[32px] border border-gray-100 shadow-xl p-8 text-center relative">
                ...
                <div className="flex justify-center gap-6 border-y border-gray-100 py-6 mb-6">
                  <div>
                    ...
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mt-1">Events</p>
                  </div>
            ...
            <div className="flex-1 mt-10 lg:mt-0">
              <div className="mb-8 flex items-center justify-between">
                <h1 className="text-3xl font-black text-gray-900">
                  {activeTab === "upcoming" ? "Upcoming Tickets" : "Attendance History"}
                </h1>
                <Link href="/events">
                    ...
                    <div className="w-full md:w-64 border-t-2 md:border-t-0 md:border-l-2 border-dashed border-gray-200 bg-gray-50 p-6 flex flex-col items-center justify-center relative">
                     ...
                     {(ticket as any).qrCode ? (
                      <>
                        ...
                        <button className="mt-4 text-xs font-bold text-indigo-600 hover:text-indigo-800 underline">Download PDF Ticket</button>
                      </>
                      ) : (
                        <div className="text-center">
                          ...
                          <p className="font-bold text-gray-500 text-sm">Event Ended</p>
                        </div>
                      )}
                    </div>

...
const MY_TICKETS = [
  {
    ...
    qrCode:
      "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=TKT-89231",
  },
  {
    id: "TKT-44590",
    ...
    qrCode:
      "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=TKT-44590",
  },
];
...
export default function ProfilePage() {
  ...
  return (
    <UserLayout title="Profile & My Tickets">
      <div className="bg-[#F9FAFB] min-h-screen pb-20">
        {/* 1. PROFILE HEADER COVER */}
        <div className="h-64 md:h-80 w-full bg-linear-to-r from-indigo-900 via-purple-900 to-indigo-900 relative overflow-hidden">
          {/* Decorative Pattern */}
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 -mt-24 md:-mt-32">
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="w-full lg:w-80 shrink-0">
              <div className="bg-white rounded-4xl border border-gray-100 shadow-xl p-8 text-center relative">
            ...
            <div className="flex-1 mt-10 lg:mt-0">
              ...
              <div className="space-y-6">
                {(activeTab === "upcoming" ? MY_TICKETS : PAST_TICKETS).map(
                  (ticket) => (
                    <div
                      key={ticket.id}
                      className="bg-white rounded-3xl border border-gray-100 shadow-sm flex flex-col md:flex-row overflow-hidden hover:shadow-xl transition-shadow relative"
                    >
                      ...
                      <div className="flex-1 flex flex-col sm:flex-row">
                        ...
                        <div className="p-6 flex flex-col justify-center">
                          <div className="flex gap-2 mb-3">
                            <span
                              className={`text-[10px] font-black px-3 py-1 rounded-md uppercase tracking-widest inline-block ${activeTab === "upcoming" ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-600"}`}
                            >
                              {ticket.status}
                            </span>
                      ...
                      {/* Right Section: QR Code & Perforation (Dashed Border) */}
                      <div className="w-full md:w-64 border-t-2 md:border-t-0 md:border-l-2 border-dashed border-gray-200 bg-gray-50 p-6 flex flex-col items-center justify-center relative">
                        {/* Round holes simulating ticket tear line */}
                        ...
                        {(ticket as any).qrCode ? (
                          <>
                            <div className="bg-white p-2 rounded-xl border border-gray-200 shadow-sm mb-3">
                              <img
                                src={(ticket as any).qrCode}
                                alt="QR Code"
                                className="w-24 h-24"
                              />
                            </div>
                            <p className="font-black text-gray-900 tracking-widest text-sm">
                              {ticket.id}
                            </p>
                            <button className="mt-4 text-xs font-bold text-indigo-600 hover:text-indigo-800 underline">
                              Download PDF Ticket
                            </button>
                          </>
                        ) : (

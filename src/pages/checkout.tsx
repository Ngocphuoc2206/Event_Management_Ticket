...
export default function CheckoutPage() {
  ...
  // Giả lập quá trình gọi API thanh toán
  const handlePayment = () => {
    setIsProcessing(true);
    // Đợi 1.5 giây để tạo cảm giác hệ thống đang xử lý thẻ
    setTimeout(() => {
    ...
    <UserLayout title="Secure Checkout">
      <div className="bg-[#F9FAFB] min-h-screen py-16 px-6 relative">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10">
            <h1 className="text-4xl font-black text-gray-900">Thanh toán an toàn</h1>
            <p className="text-gray-500 mt-2 font-medium">Vui lòng kiểm tra thông tin và hoàn tất việc mua vé.</p>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-indigo-500 rounded-2xl p-6 bg-indigo-50/30">
                    <label className="flex items-center gap-3 cursor-pointer mb-5">
                      ...
                      <span className="font-bold text-gray-900">Thẻ Tín dụng / Ghi nợ</span>
                    </label>
                    
                    <div className="space-y-4">
                      <div>
                        <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-2">Số thẻ</label>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-2">Ngày hết hạn</label>
                ...
                <div className="p-8">
                  <div className="flex justify-between items-start mb-6 border-b border-gray-100 pb-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 font-medium">Số lượng: 2</p>
                    </div>
                  ...
                  <div className="flex bg-gray-50 rounded-xl p-1 mb-6 border border-gray-100">
                    <input type="text" placeholder="Mã giảm giá" className="bg-transparent flex-1 px-4 text-sm outline-none font-medium" />
                  ...
                  <div className="space-y-3 text-sm font-bold text-gray-500 mb-6">
                    <div className="flex justify-between"><span>Tạm tính</span><span className="text-gray-900">$240.00</span></div>
                    <div className="flex justify-between"><span>Phí dịch vụ</span><span className="text-gray-900">$18.50</span></div>
                    <div className="flex justify-between"><span>Thuế</span><span className="text-gray-900">$12.40</span></div>
                  </div>
                  ...
                  {/* NÚT THANH TOÁN KÈM TRẠNG THÁI LOADING */}
                  <button 
                  ...
                  >
                    {isProcessing ? (
                      ...
                      <>
                        Xác nhận mua <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                      </>
                    )}
                  </button>

                  <p className="text-center text-[10px] text-gray-400 mt-4 font-bold">
                    Bằng việc xác nhận, bạn đồng ý với Điều khoản và Chính sách hoàn tiền của chúng tôi.
                  </p>
                </div>
              </div>
            </div>
        ...
        {showModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-gray-900/60 backdrop-blur-sm transition-opacity">
            <div className="bg-white rounded-[40px] p-10 max-w-md w-full shadow-2xl relative transform transition-all duration-300 scale-100">
              ...
              <h2 className="text-3xl font-black text-gray-900 text-center mb-2">Thành công!</h2>
              <p className="text-gray-500 text-center font-medium mb-8 leading-relaxed">
                Thanh toán <strong className="text-gray-900">$270.90</strong> hoàn tất. Vé điện tử (E-ticket) đã được gửi đến email <strong className="text-indigo-600">alex@example.com</strong> của bạn.
              </p>

        ...
        <div className="mx-auto flex min-h-screen w-full max-w-[1536px] flex-col lg:flex-row">
          ...
          <main className="flex-1 overflow-hidden">
            ...
            <div className="flex flex-col xl:flex-row">
              <aside className="w-full shrink-0 border-b border-slate-200/50 bg-white p-6 sm:p-8 xl:h-[calc(100vh-64px)] xl:w-72 xl:overflow-y-auto xl:border-b-0 xl:border-r">
                ...
                <div className="mt-8 flex flex-col gap-8">
                  ...
                  <div className="relative h-20">
                    ...
                    <div className="absolute left-0 top-11 h-1.5 w-56 rounded-full bg-slate-200" />
                    <div className="absolute left-0 top-[58px] inline-flex w-56 items-start justify-between text-[10px] font-bold uppercase leading-4 tracking-wide text-slate-400">
                      <span>$0</span>
                      <span>$500+</span>
                    </div>
                  </div>
              ...
              <div className="flex-1 overflow-y-auto p-6 sm:p-8 lg:p-12">
                ...
                <section className="mt-12 grid w-full grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                ...
                <footer className="mt-16 inline-flex w-full flex-col items-start gap-16 border-t border-slate-200/50 pt-16">
                  <div className="inline-flex w-full flex-col items-start">
                    <div className="inline-flex w-full flex-col items-start gap-6">
                    ...
                    <div className="inline-flex w-full flex-col items-start gap-6 pb-20 pt-8">
                      <div className="flex w-full flex-col items-start">
                    ...
                    <div className="inline-flex w-full flex-col items-start gap-6 pb-20">
                      <div className="flex w-full flex-col items-start">
                    ...
                    <div className="inline-flex w-full flex-col items-start gap-6 pb-36">
                      <div className="flex w-full flex-col items-start">
                  ...
                  <div className="inline-flex w-full flex-col items-start gap-4 border-t border-slate-100 py-8 lg:flex-row lg:items-center lg:justify-between">

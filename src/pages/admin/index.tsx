...
import { getDashboardStats } from "@/features/admin/users.service";
import {
  Users,
  Ticket,
  DollarSign,
  ...
  const STATS = [
    {
      ...
      icon: Users,
      trend: `+${data.stats.activeUsers}%`,
      color: "text-blue-600",
      bg: "bg-blue-50",
    },
    {
      label: "Active Tickets",
      value: formatNumber(data.stats.totalTicketsSold),
      icon: Ticket,
      trend: "+5.2%",
    ...
    },
    {
      ...
      value: data.stats.pendingApprovalEvents.toString(),
      icon: Activity,
      trend: `${data.stats.publishedEvents} published`,
          ...
          <div className="flex justify-between items-center mb-8">
            <div>
              ...
              <p className="text-sm text-slate-400 font-medium">
                Monitoring EventHub platform activities
              </p>
            </div>
              ...
              <tbody className="divide-y divide-slate-50">
                {data.isLoading && (
                  <tr>
                    <td
                      colSpan={5}
                      className="py-8 text-center text-xs font-black text-slate-400"
                    >
                  ...
                  data.recentEvents.map((event) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-5 text-center text-xs font-bold text-slate-600">
          ...
          <div className="relative z-10 h-full flex flex-col">
            <div className="mb-8">
              ...
              <h3 className="text-2xl font-black mb-2 leading-tight">
                Monthly Growth <br /> Insights
              </h3>
              <p className="text-indigo-200 text-xs font-medium">
                Your platform revenue is up 18% compared to last month. Keep it
                up!
              </p>
            </div>
            ...
            <div className="mt-auto space-y-4">
              <div className="bg-white/10 backdrop-blur-md p-5 rounded-[24px] border border-white/10">
                <p className="text-[10px] uppercase font-black text-indigo-300 tracking-widest mb-1">
                  Monthly Target
                </p>
                ...
                <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(100, (data.stats.monthlyRevenue / 100000) * 100)}%`,
                    }}
                  ></div>
                </div>
              </div>

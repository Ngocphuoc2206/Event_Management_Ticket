...
import { 
  ...
  Settings, PauseCircle, PlayCircle, Edit3
} from "lucide-react";
...
const TICKET_TIERS = [
  ...
  },
  {
    ...
    revenue: "$553,150",
    status: "ON_SALE",
    scanRate: "85%" // Đã diễn ra và check-in
  },
  {
    id: "TIER-04",
    ...
    <AdminLayout title=""> 
      <div className="flex flex-col gap-8 animate-in fade-in duration-500 pb-10 relative">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          <button className="px-8 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-full transition-all text-sm shadow-[0_4px_14px_0_rgba(79,70,229,0.39)] hover:shadow-[0_6px_20px_rgba(79,70,229,0.23)] active:translate-y-0 flex items-center gap-2">

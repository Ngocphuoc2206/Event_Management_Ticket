...
const SCHEDULED_REPORTS = [
  {
    ...
    schedule: "Every Monday, 06:00 AM",
    tags: ["PDF + CSV"],
    avatars: ["AM", "JD"],
  },
  {
    title: "Investor Dashboard Export",
...
export default function SupportHubPage() {
    ...
    <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm max-w-3xl animate-in fade-in slide-in-from-bottom-2">
      ...
      <form className="space-y-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            rows={5}
            className="p-3 border border-slate-200 rounded-xl bg-slate-50 resize-none outline-none focus:ring-2 focus:ring-blue-100"
  ...
  const renderReportsTab = () => (
    <div className="animate-in fade-in slide-in-from-bottom-2 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="relative w-full max-w-xl">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 bg-slate-50 rounded-2xl text-sm outline-none focus:ring-2 focus:ring-indigo-100"
          />
        </div>
      ...
      <div className="flex justify-end gap-3">
        <button className="flex items-center gap-3 px-6 py-4 bg-white border border-slate-100 text-slate-900 font-black rounded-[20px] shadow-sm">
          <Clock className="text-indigo-600" size={20} /> Schedule Report
        </button>
        <button className="flex items-center gap-3 px-6 py-4 bg-[#3b49df] text-white font-black rounded-[20px] shadow-lg shadow-indigo-100">
          <Plus size={20} /> Generate Custom
        </button>
      </div>
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="bg-white p-10 rounded-[40px] border border-slate-100 shadow-sm">
            <div className="flex items-center gap-2 mb-8">
              ...
              <h2 className="text-xl font-[1000] text-slate-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                ...
                <select className="w-full p-4 bg-slate-50 rounded-2xl font-bold outline-none">
                ...
                <div className="flex p-1 bg-slate-100 rounded-2xl">
                  {["Daily", "Monthly"].map((t) => (
                    <button
                      ...
                      className={`flex-1 py-3 rounded-xl text-sm font-black transition-all ${granularity === t ? "bg-white text-indigo-600 shadow-sm" : "text-slate-400"}`}
                    >
                      {t}
                    </button>
                  ))}
            ...
            <div className="mt-12 pt-8 border-t flex items-center justify-between">
              ...
              <button className="flex items-center gap-3 px-10 py-4 bg-[#3b49df] text-white font-black rounded-2xl shadow-xl">
                Run Engine <Play size={16} fill="white" />
              </button>
            </div>
          </div>

          <div className="bg-white rounded-[40px] border border-slate-100 shadow-sm p-8">
            <h2 className="text-xl font-[1000] text-slate-900 mb-6">
              Recently Generated
            </h2>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-slate-50/50 p-8 rounded-[40px] border border-slate-100 h-full">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="font-black text-slate-900">Scheduled Reports</h3>
            </div>
  ...
  // --- MAIN RENDER ---
  return (
    <AdminLayout title="Support Page">
      <div className="p-6 max-w-400 mx-auto">
        <header className="mb-6">
          ...
          <p className="text-slate-500 text-sm">
            Please select a category to view or send us your feedback.
          </p>
        </header>
        ...
        <footer className="flex justify-between items-center mt-10 pt-6 border-t border-slate-100">
          <p className="text-[11px] font-bold text-slate-400">
            © 2023 EventHub Admin Panel.{" "}
            <span className="text-emerald-500">System Stable</span>
          </p>
          <div className="flex items-center gap-4">
            <button className="p-3 bg-white border border-slate-100 rounded-2xl text-slate-500">
              <Share2 size={18} />
            </button>
            <button className="flex items-center gap-3 px-8 py-4 bg-[#3b49df] text-white font-black rounded-2xl shadow-lg shadow-indigo-100">
              <Mail size={18} /> Send Archive
            </button>
          </div>
        </footer>
      </div>

  ...
  return (
    <AdminLayout title={"Create User"}>
      <div className="max-w-4xl mx-auto pb-10">
        ...
        <Link
          href="/admin/users"
          className="group flex items-center gap-2 text-indigo-600 mb-6 w-fit transition-all"
        >
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-500 mt-1 font-medium">
            Configure account settings and platform permissions.
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all font-medium"
                  />
                </div>
              </div>
              <div className="space-y-2">
          ...
          <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-sm">
            <div className="flex items-center gap-3 mb-8">
              <div className="p-2.5 bg-purple-50 text-purple-600 rounded-xl shadow-inner">
                <Shield size={20} />
              </div>
              <h2 className="text-xl font-bold text-slate-900">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <label
                    key={perm.label}
                    className="flex items-start gap-4 p-4 border border-slate-100 bg-slate-50/30 rounded-2xl hover:bg-slate-50 cursor-pointer transition-all"
                  >
                    <input
                      type="checkbox"
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-6 p-4 bg-amber-50/50 rounded-2xl">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-slate-600">
                  An invitation link will be sent to the user&apos;s email to
                  set their password.
                </div>
              </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-4">
            ...
            <button
              type="submit"
              className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-10 py-3 rounded-2xl font-bold shadow-xl shadow-indigo-200 transition-all hover:-translate-y-0.5 active:translate-y-0"
            >
              <Save size={18} />
              Create User
            </button>

...
export const EVENT_LIST = [
  { id: 1, title: "Neon Nights: Techno Festival", type: "Music", dateFilter: "This Weekend", date: "Oct 18 • 9:00 PM", fullDate: "October 18, 2024", location: "Warehouse 42, Los Angeles", price: 45, badge: "🔥 HOT", 
    image: "https://images.unsplash.com/photo-1574169208507-84376144848b?q=80&w=1000&auto=format&fit=crop", 
    description: "Đắm chìm trong không gian âm nhạc điện tử huyền ảo với hệ thống ánh sáng neon và dàn loa công suất lớn.", 
    attendees: ["https://i.pravatar.cc/150?u=1", "https://i.pravatar.cc/150?u=2", "https://i.pravatar.cc/150?u=3"] },
  { id: 2, title: "Global AI & Tech Summit", type: "Tech", dateFilter: "This Month", date: "Nov 02 • 8:00 AM", fullDate: "November 02, 2024", location: "Innovation Hub, SF", price: 199, badge: "SELLING FAST", 
    image: "https://images.unsplash.com/photo-1505373877841-8d25f7d46678?q=80&w=1000&auto=format&fit=crop", 
    description: "Hội nghị công nghệ quy tụ các chuyên gia AI và Robotics hàng đầu để thảo luận về tương lai số.", 
    attendees: ["https://i.pravatar.cc/150?u=4", "https://i.pravatar.cc/150?u=5", "https://i.pravatar.cc/150?u=6"] },
  { id: 3, title: "Midnight Food & Wine", type: "Food", dateFilter: "This Weekend", date: "Oct 20 • 6:00 PM", fullDate: "October 20, 2024", location: "Waterfront Park, Seattle", price: 25, badge: null, 
    image: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=1000&auto=format&fit=crop", 
    description: "Lễ hội ẩm thực ngoài trời với những món ăn tinh tế và các loại rượu vang trứ danh khắp thế giới.", 
    attendees: ["https://i.pravatar.cc/150?u=7", "https://i.pravatar.cc/150?u=8", "https://i.pravatar.cc/150?u=9"] },
  { id: 4, title: "Modern Art Exhibition", type: "Art", dateFilter: "This Month", date: "Oct 25 • 10:00 AM", fullDate: "October 25, 2024", location: "MOMA Gallery, New York", price: 15, badge: "NEW", 
    image: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?q=80&w=1000&auto=format&fit=crop", 
    description: "Khám phá các tác phẩm nghệ thuật đương đại từ những nghệ sĩ trẻ triển vọng nhất toàn cầu.", 
    attendees: ["https://i.pravatar.cc/150?u=10", "https://i.pravatar.cc/150?u=11", "https://i.pravatar.cc/150?u=12"] },
  { id: 5, title: "City Marathon 2024", type: "Sports", dateFilter: "Next Month", date: "Nov 10 • 5:00 AM", fullDate: "November 10, 2024", location: "Downtown, Chicago", price: 55, badge: null, 
    image: "https://images.unsplash.com/photo-1552674605-15c37042ce88?q=80&w=1000&auto=format&fit=crop", 
    description: "Thử thách bản thân với đường chạy 42km xuyên qua những con phố đẹp nhất trung tâm Chicago.", 
    attendees: ["https://i.pravatar.cc/150?u=13", "https://i.pravatar.cc/150?u=14", "https://i.pravatar.cc/150?u=15"] },
  { id: 6, title: "Startup Pitch Deck", type: "Business", dateFilter: "Next Month", date: "Nov 15 • 2:00 PM", fullDate: "November 15, 2024", location: "Capital Tower, Austin", price: 0, badge: "FREE", 
    image: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=1000&auto=format&fit=crop", 
    description: "Cơ hội lắng nghe và kết nối với các startup kỳ lân tương lai trong buổi gọi vốn đầy kịch tính.", 
    attendees: ["https://i.pravatar.cc/150?u=16", "https://i.pravatar.cc/150?u=17", "https://i.pravatar.cc/150?u=18"] }
];
...
export default function EventsPage() {
  ...
  const filteredEvents = useMemo(() => {
    return EVENT_LIST.filter(event => {
      const matchCategory = selectedCategories.length === 0 || selectedCategories.includes(event.type);
      const matchDate = selectedDate === "All" || event.dateFilter === selectedDate;
    ...
    <UserLayout title="Explore Events">
      ...
      <div className="bg-gray-900 pt-28 pb-16 px-6 relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto relative z-10 text-center">
            <h1 className="text-4xl md:text-5xl font-black text-white mb-4">Khám Phá Sự Kiện</h1>
            <p className="text-gray-400 text-lg">Tìm kiếm niềm vui tiếp theo của bạn từ hàng ngàn sự kiện hấp dẫn.</p>
         </div>
      </div>
          ...
          <aside className="w-full lg:w-72 space-y-8 flex-shrink-0">
            <div className="bg-white p-7 rounded-[32px] border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                {["All", "Music", "Tech", "Food", "Art", "Sports", "Business"].map((cat) => (
                  <label key={cat} className="flex items-center gap-3 cursor-pointer group">
                    ...
                    />
                    <span className="font-bold text-gray-600 group-hover:text-indigo-600 transition-colors">{cat}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="bg-white p-7 rounded-[32px] border border-gray-100 shadow-sm">
              ...
              <div className="space-y-4">
                {["All", "This Weekend", "This Month", "Next Month"].map((date) => (
                  <label key={date} className="flex items-center gap-3 cursor-pointer group">
                    ...
                    />
                    <span className="font-bold text-gray-600 group-hover:text-indigo-600 transition-colors">{date}</span>
                  </label>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {filteredEvents.length > 0 ? filteredEvents.map((event) => (
                    ...
                    <div className="mt-auto pt-5 border-t border-gray-100 flex justify-between items-center">
                       <div className="flex -space-x-2">
                         {event.attendees.map((avt, idx) => (
                           <img key={idx} className="w-8 h-8 rounded-full border-2 border-white shadow-sm" src={avt} alt="Attendee" />
                         ))}
                       </div>
                       <Link href={`/events/${event.id}`}>
                          <button className="bg-gray-900 text-white px-5 py-2.5 rounded-xl font-bold hover:bg-indigo-600 transition-colors text-sm shadow-md active:scale-95">
                            {event.price === 0 ? "Free Ticket" : `$${event.price}`}
                          </button>
                       </Link>
                    </div>
                  </div>
                ...
                <div className="col-span-full text-center py-20 bg-white rounded-[32px] border border-gray-100">
                   ...
                   <h3 className="text-2xl font-black text-gray-900 mb-2">Không tìm thấy sự kiện</h3>
                   <p className="text-gray-500">Thử thay đổi bộ lọc hoặc xem lại sau nhé.</p>
                </div>
              )}
            </div>
          </main>

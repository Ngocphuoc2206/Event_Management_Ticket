            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="space-y-1">
                ...
                <p className="pt-1 text-lg text-gray-700">
                  Set the location and schedule for your event.
                </p>
              </div>
              <div className="space-y-0.5 text-right">
                <p className="text-2xl font-bold leading-8 text-zinc-900">
                  40%
                </p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <label
                        htmlFor="venue-name"
                        className="text-sm font-bold uppercase tracking-tight text-gray-700"
                      >
                        Venue Name
                      </label>
                      <input
            ...
            <aside className="space-y-8">
              <article className="relative h-72 overflow-hidden rounded-3xl bg-white shadow-lg outline outline-1 outline-slate-300/10">
                ...
                <div className="absolute bottom-6 left-6">
                  ...
                  <h4 className="text-xl font-bold text-white">
                    {venueName.trim() || "Map visualization"}
                  </h4>
                </div>
              </article>
              ...
              <div className="space-y-4">
                <article className="rounded-3xl bg-gradient-to-br from-violet-100 to-purple-200/70 p-6 outline outline-1 outline-violet-500/20">
                  ...
                  <h5 className="mt-4 text-base font-bold text-violet-950">
                    Pro Tip
                  </h5>
                  <p className="mt-1 text-sm leading-6 text-violet-950/85">
                    Consider traffic and peak hours when setting your start time
                    to keep check-in smooth for large crowds.
                  </p>
                </article>

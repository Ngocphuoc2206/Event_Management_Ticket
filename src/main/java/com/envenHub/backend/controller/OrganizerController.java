...
public class OrganizerController {
    ...
    @GetMapping("/events")
    public ApiResponse<PagedResponse<EventListResponse>> getMyEvents(
        ...
        return ApiResponse.<PagedResponse<EventListResponse>>builder()
                .results(eventService.getMyEvents(search, status, page, size, sortBy, sortDir, authentication))
                .build();
    }

    @GetMapping("/events/{id}")
    public ApiResponse<EventDetailResponse> getMyEventDetail(
            @PathVariable String id,
            Authentication authentication
    ) {
        return ApiResponse.<EventDetailResponse>builder()
                .results(eventService.getMyEventDetail(id, authentication))
                .build();
    }
    ...
    public ApiResponse<EventDetailResponse> submitEvent(
            @PathVariable String id,
            Authentication authentication
    ) {

      ...
      <aside className="w-[280px] bg-white border-r border-slate-100 flex flex-col sticky top-0 h-screen z-40">
        <div className="p-7">
          <div className="flex items-center gap-3 mb-10 px-1">
            ...
            <div>
              ...
              <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest mt-1 block">Admin Panel</span>
            </div>
          </div>
        ...
        <div className="mt-auto p-7 border-t border-slate-100 space-y-2">
          ...
          >
            <HelpCircle 
              size={20} 
              className={isSupportPageActive ? 'text-white' : 'text-slate-400 group-hover:text-blue-600'} 
            />
            <span className={`text-sm ${isSupportPageActive ? 'font-bold' : 'font-semibold'}`}>Support</span>
          </div>
      ...
      <main className="flex-1 flex flex-col">
        <header className="h-20 bg-white/80 backdrop-blur-xl border-b border-slate-100 flex items-center justify-between px-8 sticky top-0 z-30">
          <div>
             ...
             <p className="text-xs text-slate-400 font-medium -mt-0.5">Platform management system v2.0</p>
          </div>
          
          <div className="flex items-center gap-5">
            <div className="relative hidden lg:block">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={16} />
              <input type="text" placeholder="Global search..." className="pl-11 pr-4 py-2.5 bg-slate-100/50 rounded-full text-sm focus:outline-none focus:ring-2 ring-blue-500/10 w-80 transition-all border border-transparent focus:bg-white focus:border-blue-100 font-semibold" />
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left hidden sm:block">
                <p className="text-sm font-black text-slate-900 leading-none">Alex Phước</p>
                <p className="text-[10px] text-blue-500 font-bold uppercase tracking-tight mt-1">Super Admin</p>
              </div>
            </div>
          </div>
        </header>
